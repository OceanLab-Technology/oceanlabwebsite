...
export default function FeaturesSection() {
    return (
        <section className="bg-gray-50 py-16 md:py-32 dark:bg-transparent" id="Enterprise">
            <div className="mx-auto max-w-5xl px-6">
                <div className="@container mx-auto max-w-5xl px-6">
                    <div className="text-center">
                        <h2 className="text-balance text-4xl font-semibold lg:text-5xl">Tailored Enterprise Solutions for High-Impact Teams</h2>
                        <p className="mt-4">Powering decision-making, scale, and security for engineering-driven organizations.</p>
                    </div>
                        ...
                        <div className="relative z-10 grid grid-cols-6 gap-3">
                            <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
                                <CardContent className="relative m-auto size-fit pt-6">
                                    ...
                                    <h2 className="mt-6 text-center text-3xl font-semibold">Guarantee. 99.99% Uptime SLA.</h2>
                                </CardContent>
                            </Card>
                            <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                                <CardContent className="pt-6">
                                    <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/30">
                                        <MovingBorderAvatar />
                                    </div>
                                    <div className="relative z-10 mt-6 space-y-2 text-center">
                                        ...
                                        <p className="text-foreground">SOC2, Role-Based Access, and encrypted data pipelines.</p>
                                    </div>
                                </CardContent>
                            </Card>
                            <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                                <CardContent className="pt-6">
                                    ...
                                    <div className="relative z-10 mt-14 space-y-2 text-center">
                                        <h2 className="text-lg font-medium transition">Lightning-Fast Delivery</h2>
                                        <p className="text-foreground">Sub-second response times at global scale with optimized infra.</p>
                                    </div>
                                </CardContent>
                            </Card>
                                ...
                                <CardContent className="grid pt-6 sm:grid-cols-2">
                                    <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                        ...
                                        <div className="space-y-2">
                                            <h2 className="group-hover:text-secondary-950 text-lg font-medium text-zinc-800 transition dark:text-white">Observability & Insights</h2>
                                            <p className="text-foreground">Full-stack monitoring, distributed tracing, and actionable dashboards — built in, not bolted on.</p>
                                        </div>
                                    </div>
                            ...
                            <Card className="card variant-outlined relative col-span-full overflow-hidden lg:col-span-3">
                                <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                    <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                        ...
                                        <div className="space-y-2">
                                            <h2 className="text-lg font-medium transition">Purpose-Specific Roles</h2>
                                            <p className="text-foreground">Admins, Auditors, Engineers, Clients — each with scoped control.</p>
                                        </div>
                                    </div>
...
function MovingBorderAvatar() {
    ...
    return (
        <div className="relative mx-auto size-32 rounded-full p-[2px]">
            {/* Animated border layer */}
            <div
                ref={borderRef}
                className="absolute inset-0 rounded-full"
                style={{
                    background: 'conic-gradient(#FF5733, #33FF57, #3357FF, #F1C40F)',
                }}
            />
            {/* Inner avatar container with SVG */}
            <div className="relative z-10 flex size-full items-center justify-center rounded-full bg-background dark:bg-black">
                {/* paste your <svg> here as-is */}
                <svg
                ...
                >
                    ...
                    {/* ... SVG paths (as in your current code) ... */}
                </svg>
            </div>
        </div>
    );
